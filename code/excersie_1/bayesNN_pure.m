...
net1=feedforwardnet(num_neurons1,'traingd');
...
net6=feedforwardnet(num_neurons1,'trainlm');
net7=feedforwardnet(num_neurons1,'trainbr');
...
net7=train(net7,p,t);
a11=sim(net1,p); 
% a21=sim(net2,p); a31=sim(net3,p); a41=sim(net4,p); a51=sim(net5,p); 
a61=sim(net6,p); a71=sim(net7,p);  % simulate the networks with the input vector p
...
net7=train(net7,p,t);
a12=sim(net1,p); 
% a22=sim(net2,p); a32=sim(net3,p); a42=sim(net4,p); a52=sim(net5,p); 
a62=sim(net6,p); a72=sim(net7,p); % simulate the networks with the input vector p
...
net7=train(net7,p,t);
a13=sim(net1,p);
% a23=sim(net2,p); a33=sim(net3,p); a43=sim(net4,p); a53=sim(net5,p); 
a63=sim(net6,p);  a73=sim(net7,p);
...
net7=train(net7,p,t);
a14=sim(net1,p);
% a24=sim(net2,p); a34=sim(net3,p); a44=sim(net4,p); a54=sim(net5,p);
a64=sim(net6,p); a74=sim(net7,p);
...
net7=train(net7,p,t);
a15=sim(net1,p); 
% a25=sim(net2,p); a35=sim(net3,p); a45=sim(net4,p); a55=sim(net5,p);
a65=sim(net6,p);  a75=sim(net7,p); 
...
net7=train(net7,p,t);
a16=sim(net1,p); 
% a26=sim(net2,p); a36=sim(net3,p); a46=sim(net4,p); a56=sim(net5,p);
a66=sim(net6,p);  a76=sim(net7,p);

%plots
figure
subplot(2,3,1);
plot(x,y,'bx',x,cell2mat(a11),'y',x,cell2mat(a61),'c', x,cell2mat(a71),'r-'); % plot the sine function and the output of the networks
title('1 epoch');
legend('target','traingd','trainlm', 'trainbr');
%
subplot(2,3,2);
plot(x,y,'bx',x,cell2mat(a12),'y',x,cell2mat(a62),'c', x,cell2mat(a72),'r-'); % plot the sine function and the output of the networks
title('10 epoch');
legend('target','traingd', 'trainlm', 'trainbr');
%
subplot(2,3,3);
plot(x,y,'bx',x,cell2mat(a13),'y',x,cell2mat(a63),'c', x,cell2mat(a73),'r-'); % plot the sine function and the output of the networks
title('50 epoch');
legend('target','traingd','trainlm', 'trainbr');

subplot(2,3,4);
plot(x,y,'bx',x,cell2mat(a14),'y',x,cell2mat(a64),'c', x,cell2mat(a74),'r-'); % plot the sine function and the output of the networks
title('100 epoch');
legend('target','traingd', 'trainlm', 'trainbr');

subplot(2,3,5);
plot(x,y,'bx',x,cell2mat(a15),'y',x,cell2mat(a65),'c', x,cell2mat(a75),'r-'); % plot the sine function and the output of the networks
title('500 epoch');
legend('target','traingd','trainlm', 'trainbr');

subplot(2,3,6);
plot(x,y,'bx',x,cell2mat(a16),'y',x,cell2mat(a66),'c', x,cell2mat(a76),'r-'); % plot the sine function and the output of the networks
title('1000 epoch');
legend('target','traingd', 'trainlm', 'trainbr');
% 
% %plots
