...
net7.iw{1,1}=net6.iw{1,1};  %set the same weights and biases for the networks 
net7.lw{2,1}=net6.lw{2,1};
net7.b{1}=net6.b{1};
net7.b{2}=net6.b{2};
...
figure
subplot(2,3,1);
plot(x,y,'bx',x,cell2mat(a61),'g', x,cell2mat(a71),'r-'); % plot the sine function and the output of the networks
title('1 epoch');
legend('target','trainlm', 'trainbr');
%
subplot(2,3,2);
plot(x,y,'bx',x,cell2mat(a62),'g', x,cell2mat(a72),'r-'); % plot the sine function and the output of the networks
title('10 epoch');
legend('target', 'trainlm', 'trainbr');
%
subplot(2,3,3);
plot(x,y,'bx',x,cell2mat(a63),'g', x,cell2mat(a73),'r-'); % plot the sine function and the output of the networks
title('50 epoch');
legend('target','trainlm', 'trainbr');

subplot(2,3,4);
plot(x,y,'bx',x,cell2mat(a64),'g', x,cell2mat(a74),'r-'); % plot the sine function and the output of the networks
title('100 epoch');
legend('target','trainlm', 'trainbr');

subplot(2,3,5);
plot(x,y,'bx',x,cell2mat(a65),'g', x,cell2mat(a75),'r-'); % plot the sine function and the output of the networks
title('500 epoch');
legend('target','trainlm', 'trainbr');

subplot(2,3,6);
plot(x,y,'bx',x,cell2mat(a66),'g', x,cell2mat(a76),'r-'); % plot the sine function and the output of the networks
title('1000 epoch');
legend('target', 'trainlm', 'trainbr');
% 
% %plots
