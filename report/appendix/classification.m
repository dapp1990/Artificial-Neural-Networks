...
% target set
n_positive = ...
    length(positive_samples_4) + length(positive_samples_5);
...
for neurons=5:5:50
	...
	ccr1 = ...
        (sum(sign(predictions) == ...
        ground_truth')*100)/length(ground_truth);
...
for neurons=5:5:50
    for k=1:11
        ...
        training_set_reduction = ... 
            projection_training*training_set';
        ...
        net2=...
            train(net2,training_set_reduction,validation_set');
